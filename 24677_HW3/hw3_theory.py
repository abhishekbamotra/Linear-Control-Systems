...
class AnswersHw3(): # We define a "class". No actions.
	...
	def exercise_3(self):
		...
		"""
		self.answer3_1 = * # Minimum distance
		self.answer3_2 = np.array([*, *, *]) # Projection point
	...
	def exercise_6(self):
		...
		"""
		self.answer6_1_rank = *
		self.answer6_1_nullity = *
		self.answer6_2_rank = *
		self.answer6_2_nullity = *
		self.answer6_3_rank = *
		self.answer6_3_nullity = *
